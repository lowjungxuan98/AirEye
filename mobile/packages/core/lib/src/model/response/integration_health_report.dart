...
class IntegrationHealthReport {
  const IntegrationHealthReport({required this.version, required this.ok, required this.firebase, required this.llm, required this.s3});
  ...
  JsonMap toJson() => {'version': version, 'ok': ok, 'firebase': firebase.toJson(), 'llm': llm.toJson(), 's3': s3.toJson()};
}
