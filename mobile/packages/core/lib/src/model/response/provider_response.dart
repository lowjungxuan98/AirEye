...
class ProviderResponse {
  ...
  factory ProviderResponse.fromJson(JsonMap json) => ProviderResponse(
    ...
    availableProviders: (json['available_providers'] as List<dynamic>).map((e) => LlmProvider.fromValue(e as String)).toList(),
  );

  JsonMap toJson() => {'current_provide': currentProvider.value, 'available_providers': availableProviders.map((e) => e.value).toList()};
}
