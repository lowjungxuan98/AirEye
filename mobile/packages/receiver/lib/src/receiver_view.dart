  ...
  Widget buildPage(context, ref) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        child: isCapturing ? const SizedBox(width: 24, height: 24, child: CircularProgressIndicator(strokeWidth: 2)) : const Icon(Icons.add),
      ),
      body: Stack(
        children: [
          switch (state) {
            ...
            ReceiverReady(:final items, :final isLoadingMore, :final isRefreshing, :final regeneratingIds) => Stack(
              children: [
                RefreshIndicator(
                        ...
                        SliverPadding(
                          ...
                          sliver: SliverGrid(
                            ...
                            delegate: SliverChildBuilderDelegate((context, index) {
                              ...
                              return GridItem(item: item, imageUrl: imageUrl, isRegenerating: regeneratingIds.contains(imageUrl), onRegenerate: () => controller.regenerate(item));
                ...
                if (isRefreshing)
                  const ColoredBox(
                    ...
                    child: SizedBox.expand(child: Center(child: CircularProgressIndicator())),
                  ),
              ],
            ),
