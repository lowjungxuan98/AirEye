import type { AirEyeUpload, AirEyeUploadRow } from "../src/api/v1/model/import.model";
 ...
 * (newest {@link AirEyeUploadRow.createdAt} first), same sort as {@link FirebaseUploadRepository}.
 */
export class InMemoryUploadRepository implements UploadRepository {
  private readonly rows = new Map<string, AirEyeUploadRow>();
